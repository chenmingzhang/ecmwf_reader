...
grbs_evap=pygrib.open("/mnt/d2text4/_mars-atls18-95e2cf679cd58ee9b4db4dd119a05a8d-it73Gf.grib")
...
grbs_rain=pygrib.open("/mnt/d2text4/_mars-atls18-95e2cf679cd58ee9b4db4dd119a05a8d-xRt2Ty.grib")
elapsed_time_min=(time.time()-start_time)/60
print("it takes %8.3e minutes for loading evaporation"  % (elapsed_time_min))
